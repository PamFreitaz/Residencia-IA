...
caminho_md = os.path.join(pasta_atual, "markdown", "retrieval_augmented_generation.md")

doc_id = "documento_11"
doc_name = "retrieval_augmented_generation.pdf"
...
# SALVAR O SUMMARY.JSON NO DOCUMENTO_11
